...
namespace MVC_CRUD_Migraciones_Automatica_WebAPI.Controllers
{
    public class DocumentTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DocumentTypeID,Descripction")] DocumentType documentType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DocumentTypeID,Descripction")] DocumentType documentType)
        {
            if (ModelState.IsValid)
            {
