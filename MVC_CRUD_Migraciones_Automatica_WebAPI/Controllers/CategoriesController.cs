...
namespace MVC_CRUD_Migraciones_Automatica_WebAPI.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CategotyID,Description")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategotyID,Description")] Category category)
        {
            if (ModelState.IsValid)
            {
